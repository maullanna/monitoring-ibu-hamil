...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') - {{ $pengaturan->nama_aplikasi ?? 'Monitoring Ibu Hamil' }}</title>
...
<div class="wrapper">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.monitoring') }}" class="nav-link {{ request()->routeIs('admin.monitoring') ? 'active' : '' }}">
                            ...
                            <p>Monitoring Dehidrasi</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.notifikasi') }}" class="nav-link {{ request()->routeIs('admin.notifikasi') ? 'active' : '' }}">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2025 <a href="#">Monitoring Ibu Hamil</a>.</strong> All rights reserved.
    </footer>
</div>
<!-- ./wrapper -->
